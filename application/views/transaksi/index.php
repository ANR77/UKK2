...
<div class="row h-100">
    ...
    <div class="col-sm-12 col-md-7" id="kiri">
        <div class="row">
            <div class="col-12">
                <div class="card shadow" id="card-spp">
                    <div class="card-header pt-4 bg-white border-0 pb-0">
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-search"><i class="fas fa-search pr-2"></i> Search Siswa</button>
                    </div>
    ...
    <div class="col-sm-12 col-md-5" id="kanan">
        <form class="card mt-sm-3 mt-md-0 shadow" action="<?= base_url('transaksi/bayar') ?>" method="post">
                ...
                <div class="col-12">
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend bg-white">
                            <span class="input-group-text text-black border-0 bg-white" id="basic-addon1"  style="font-size : 2em;">Rp.</span>
                        </div>
            ...
            <div id="kanan-bawah" class="card-footer border-top bg-white">
                <div class="form-group">
                ...
                <button id="btn-bayar" type="submit" class="btn btn-success btn-block mb-2 btn-sm" disabled>Bayar</button>
            </div>
        </form>
    </div>
</div>
