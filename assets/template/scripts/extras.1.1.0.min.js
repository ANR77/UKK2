	...
	jQuery(document).ready(function () {
		...
		s
			...
			a.find(".pp-intro-bar").click(function (s) {
				s.target === this &&
					e(this).parent().hasClass("hidden") &&
					(t.removeItem(o), a.removeClass("hidden"));
			}),
		...
		i.on("click", "li", function () {
			...
			"success" == t && (o = c),
				...
				(function (t) {
					var o = e("#main-logo");
					n || (n = o.attr("src"));
					if ("success" === t) return void o.attr("src", n);
					o.attr("src", "images/shards-dashboards-logo-" + t + ".svg");
				})(t),
				void 0 !== window.ubdChart &&
					void 0 !== window.BlogOverviewUsers &&
					(function (t) {
						(t = l[t]),
							...
							ubdChart.update(),
							e(".ubd-stats__legend .ubd-stats__item:nth-child(1) i").attr(
								"style",
								"color:" + u(t, 0.9) + ";"
							),
							e(".ubd-stats__legend .ubd-stats__item:nth-child(2) i").attr(
								"style",
								"color:" + u(t, 0.5) + ";"
							),
							e(".ubd-stats__legend .ubd-stats__item:nth-child(3) i").attr(
								"style",
								"color:" + u(t, 0.3) + ";"
							);
					})(t);
		...
		e("#social-share").sharrre({
			...
			e(".color-switcher-toggle").click(p),
			e(".color-switcher .close").click(p);
		var m = new Date();
		function p() {
			e(".color-switcher").toggleClass("visible"),
				e(".color-switcher").hasClass("visible")
					? t.setItem("_sd_cs_visible", !0, m)
					: t.setItem("_sd_cs_visible", !1, m);
		}
